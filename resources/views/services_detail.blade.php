                    ...
                    <div class="row align-items-center d-flex h-100">
                        <div class="col-md-12">
                            <div class="block">
                                ...
                                <h1 class="mb-3 mt-3 text-center">Web Design</h1>                                                                                
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-6 align-items-center d-flex">
                <div class="about-block">
                    <h1 class="title-color mb-3">Web Design</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut et mollitia autem maxime fuga sunt labore tenetur magnam, dignissimos velit enim ratione suscipit! Impedit nisi nulla ipsa eligendi, optio unde?</p>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut et mollitia autem maxime fuga sunt labore tenetur magnam, dignissimos velit enim ratione suscipit! Impedit nisi nulla ipsa eligendi, optio unde?</p>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi tenetur recusandae culpa modi maiores molestias vero necessitatibus, nihil, magni laudantium officia quisquam sunt alias unde. Placeat quod voluptates neque nostrum.</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="image-red-background">
                    <img src="{{ asset('assets/images/logo-design.jpg') }}" alt="" class="w-100">
                </div>
