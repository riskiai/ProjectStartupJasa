                    ...
                    <div class="card">
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table">
                                <tr>
                                    <th width="50">No</th>
                                    <th width="100">Blog Yang Dikomen</th>
                                    <th width="50">name</th>
                                ...
                                @if (!empty( $comments))
                                    @foreach ( $comments as $commentRow)     
                                        <tr>
                                            <td>{{ $loop->iteration + ($comments->perPage() * ($comments->currentPage() - 1)) }}</td>
                                            <td>
                                                {{ $commentRow->blog->name }}
                                            </td>
                                            {{-- <td>{{ date('d/m/Y', strtotime($faqRow->created_at)) }}</td> --}}
                                            <td>{{ $commentRow->name }}</td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('comment.edit', $commentRow->id) }}" class="">
                                                ...
                                                &nbsp;
                                                <a href="javascript:void(0);" class="" onclick="deleteComment({{ $commentRow->id }});">
